...
const AddCarForm = () => {
  ...
  // Custom hooks for API calls (MANUAL UPLOAD)
  const {
  ...
  // Custom hooks for API calls (AI UPLOAD)
  const {
  ...
  // Handle successful car addition (MANUAL UPLOAD)
  useEffect(() => {
  ...
  // Handle successful AI processing (AI UPLOAD)
  useEffect(() => {
  ...
  // Handle AI image upload with Dropzone (AI UPLOAD)
  ...
  // Handle multiple image uploads with Dropzone (MANUAL UPLOAD)
